...
A full list of tasks provided:
  ...
  rake heroku:stage:parallel        # Select all Heroku apps for later command (multi process)

Frequently used tasks are aliased into the global namespace:

  task :all           => 'heroku:stage:all'
  task :parallel      => 'heroku:stage:parallel'
...
* Masahiro Saito (https://github.com/camelmasa)
